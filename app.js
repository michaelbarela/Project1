...
$(document).ready(function(){
    ...
    //create a function that prevents submitting empty search form
    
    $("#searchForm").on("submit", (e) => {
        console.log($("#searchForm").val());
        e.preventDefault();
        
        //create var for user movie choice we'll store search result here

});
    //create var for user movie choice we'll store search result here
    //create function for axio request
    //create function for responce when request is done 
